...
variable "node_vm_size" {
  description = "VM size for worker nodes (Azure: Standard_D4s_v3, AWS: t3.xlarge)"
  type        = string
  default     = ""
}
...
locals {
  ...
  node_size  = var.node_vm_size != "" ? var.node_vm_size : (var.cloud_provider == "azure" ? "Standard_D4s_v3" : "t3.xlarge")
}
